...
body {
	...
	background-image: url(img/fondoP3.jpg);
  background-size: 100%;
}
</style>
</head>
...
<table width="98%" border="0">
          ...
          <ul class="nav" role="navigation">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="salones.php" target="admin"><i class="icon-folder-open"></i> Proyectos</a></li>
  ...
  <tr>
    <td>
    <pre><center><strong><a href="https://www.facebook.com/soft.unicorn" target="_blank" style="color:#000">Desarrollado por Jonathan Alexis - UMB</a></strong></center></pre>
    </td>
  </tr>
</table>
</body>
